  ...
  return (
    <div className="flex h-full flex-col gap-3">
      ...
      <div
        ref={scrollRef}
        className={cn(
          "relative flex-1 space-y-4 overflow-y-auto rounded-2xl p-4 backdrop-blur-sm",
          theme.surface,
        )}
      >
        <div
      ...
      <form onSubmit={handleSend} className="flex flex-col gap-1.5">
        <div
          className={cn(
            "grid grid-cols-[1fr_auto] gap-2.5 rounded-[24px] border p-2.5 shadow-[0_10px_28px_rgba(0,0,0,0.16)] backdrop-blur-xl",
            theme.inputWrap,
          )}
        >
          <textarea
            ...
            autoFocus
            className={cn(
              "ritual-chat-textarea resize-none outline-none leading-relaxed text-[15px] py-3 px-4 rounded-[18px]",
          ...
          <button
            ...
            className={cn(
              "grid h-[52px] min-w-[52px] place-items-center rounded-[18px] border text-lg shadow-sm transition",
