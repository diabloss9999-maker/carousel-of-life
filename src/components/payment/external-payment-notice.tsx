 ...
 *
 * 한국 사용자 대상 앱이 NHN KCP(PortOne 경유) 외부 결제를 사용할 때
 * Google Play 정책(25.3.2) 에 따라 결제 화면에 명시적으로 안내한다.
 *
    ...
    <div className="app-surface rounded-2xl p-4 text-[15px]">
      <div className="flex items-start gap-2.5">
        ...
        <div className="space-y-1 text-muted-foreground leading-relaxed">
          ...
          <p>
            본 앱의 결제는 Google Play 결제가 아닌 외부 결제 시스템(NHN KCP) 을
            통해 진행됩니다. 결제·환불 관련 문의는 앱 내 고객 지원으로 연락해
            주세요.
          </p>
        </div>
      </div>
