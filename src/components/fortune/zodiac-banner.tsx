    ...
    return (
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="w-full space-y-2">
          <p className="text-xs font-semibold text-center text-foreground/60 tracking-wide">✨ 잘 맞는 별자리</p>
        ...
        {/* 주의가 필요한 별자리 */}
        <div className="w-full space-y-2">
          <p className="text-xs font-semibold text-center text-foreground/60 tracking-wide">⚠️ 주의가 필요한 별자리</p>
          <div className="flex justify-center gap-3">
            {z.incompatible.map((name) => {
              ...
              return (
                <div key={name} className="flex flex-col items-center gap-1.5">
                  ...
                  <span className="text-[11px] font-medium text-destructive">{name}</span>
                </div>
              );
            })}
          </div>
  ...
  if (category === "chinese_zodiac") {
    ...
    return (
      <div className="flex flex-col items-center gap-5">
        ...
        {/* 잘 맞는 띠 */}
        <div className="w-full space-y-2">
          <p className="text-xs font-semibold text-center text-foreground/60 tracking-wide">✨ 잘 맞는 띠</p>
          <div className="flex justify-center gap-3">
        ...
        {/* 주의가 필요한 띠 */}
        <div className="w-full space-y-2">
          <p className="text-xs font-semibold text-center text-foreground/60 tracking-wide">⚠️ 주의가 필요한 띠</p>
          <div className="flex justify-center gap-3">
