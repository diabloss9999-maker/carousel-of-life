...
export function buildEchoLine(echo: EchoEntry): string {
  ...
  const lines: Record<string, string> = {
    ...
    밤: "밤의 흐름이 아직 당신을 따라다닙니다.",
    외로: "비슷한 감정이 아직 흐름에 남아 있습니다.",
