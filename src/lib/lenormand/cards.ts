...
export const LENORMAND_DECK: LenormandCard[] = [
  ...
  { id: 10, nameKo: "낫", nameEn: "Scythe", keywords: ["결단", "주의", "수확", "절단"], meaning: "빠른 결단이 필요하거나 갑작스러운 변화가 온다.", imageSrc: "/lenormand/10_scythe.webp" },
  ...
  { id: 19, nameKo: "탑", nameEn: "Tower", keywords: ["고독", "권위", "기관", "결"], meaning: "고독이나 권위, 공식적인 기관과의 관계를 나타낸다.", imageSrc: "/lenormand/19_tower.webp" },
