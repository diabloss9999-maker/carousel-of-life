...
export const IDOL_IMAGE_PROFILES: Record<CharacterId, IdolImageProfile> = {
  ...
  sage: {
    ...
    fixedSheet: [
      ...
      "- Age: exactly 22, adult male.",
      "- Role mood: intense performer, focused and athletic.",
      "- Face: angular face, strong cheekbones, defined jaw, sharper than Jaeha or Sion.",
      "- Eyes: fierce upturned eyes, intense stage focus.",
      "- Hair: midnight blue-black short hair, tight textured layers, forehead partly visible, subtle blue sheen under light.",
      "- Body: lean muscular adult idol body, 178cm impression, dancer-athlete posture.",
      "- Do not resemble Jaeha or Sion: Doyoon is more athletic, intense, and stage-driven.",
    ],
  },
  shaman: {
    age: 22,
